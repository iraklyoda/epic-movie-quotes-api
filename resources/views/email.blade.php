...
<main style="margin-left: 10%;">
    <p style="margin: 24px 0;">Hola {{$user}}</p>
    <p style="margin: 24px 0;">Thanks for joining Movie quotes! We really appreciate it. Please click the button below to verify your account:</p>
    <button style="
        color: inherit;
        border: none;
        padding: 0;
        ...
        height: 38px;
        border-radius: 4px;
        background: #E31221 none;"><a href="{{$url}}" style="text-decoration: none; color: white;">Verify email</a></button>
